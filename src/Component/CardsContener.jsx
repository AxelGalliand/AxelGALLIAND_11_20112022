...
function Location_fetch () {
	...
	// let test = [1, 5];
	// const test2 = test.map((test) => test+2);
	// console.log(test2);
	const locationArr = locations.forEach(location => {
		return (
...
export function CardsContener () {
  ...
  return (
    <div className="card-contener">
      {/* <Card title="HElllo world" cover="https://s3-eu-west-1.amazonaws.com/course.oc-static.com/projects/front-end-kasa-project/accommodation-20-1.jpg"/>
      <Card title="sqlut" />
      <Card/>
      <Card/>
      <Card/>
